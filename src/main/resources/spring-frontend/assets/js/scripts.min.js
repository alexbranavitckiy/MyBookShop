                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'recent':
                                ...
                                break;
                            case'tag':
                                getData('/api/books/tag'+ $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset <= 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'genres':
                                getData('/genres/page' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset <= 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                            ...
                            case'genre':
                                ...
                                break;
                            case'Author':
                                getData('/books/author/SLUG' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/bookReview/save', {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/rateBookReview/like', data, function (result) {
                            window.location.reload(true);
                            if (result.result) {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/changeBookStatus/rating', {
                            ...
                            if (result.result) {
                                ...
                                $('.Rating-star')
                                    .slice(0,result.averageValue).addClass('Rating-star_view');
                            } else {
